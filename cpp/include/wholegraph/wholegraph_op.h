 ...
 * @param wg_csr_row_ptr_tensor : WholeGraph Tensor of graph csr_row_ptr
 * @param wg_csr_col_ptr_tensor : WholeGraph Tensor of graph csr_col_ptr
 * @param center_nodes_tensor : None WholeGraph Tensor of center node to sample
 ...
 * @param wg_csr_row_ptr_tensor : WholeGraph Tensor of graph csr_row_ptr
 * @param wg_csr_col_ptr_tensor : WholeGraph Tensor of graph csr_col_ptr
 * @param wg_csr_weight_ptr_tensor : WholeGraph Tensor of graph edge weight
 * @param center_nodes_tensor : None WholeGraph Tensor of center node to sample
 * @param max_sample_count : maximum sample count
 * @param output_sample_offset_tensor : pointer to output sample offset
 * @param output_dest_memory_context : memory context to output dest nodes
 ...
 * @param output : WholeGraph Tensor of output
 * @return : wholegraph_error_code_t
 */
