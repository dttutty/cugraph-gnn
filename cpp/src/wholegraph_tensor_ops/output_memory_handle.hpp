...
class output_memory_handle {
 public:
  explicit output_memory_handle(wholegraph_env_func_t* env_fns, void* memory_context)
  {
  ...
  void* device_malloc(size_t elt_count, wholegraph_dtype_t data_type)
  {
    ...
    ptr_ = output_mem_fns_->malloc_fn(
      &tensor_description, WHOLEGRAPH_MA_DEVICE, memory_context_, output_mem_fns_->global_context);
    return ptr_;
  }
  void* device_malloc(wholegraph_tensor_description_t* tensor_desc)
  {
    ptr_ = output_mem_fns_->malloc_fn(
      tensor_desc, WHOLEGRAPH_MA_DEVICE, memory_context_, output_mem_fns_->global_context);
    return ptr_;
  }
  void* host_malloc(size_t elt_count, wholegraph_dtype_t data_type)
  {
    ...
    get_tensor_description(&tensor_description, elt_count, data_type);
    ptr_ = output_mem_fns_->malloc_fn(
      &tensor_description, WHOLEGRAPH_MA_HOST, memory_context_, output_mem_fns_->global_context);
    return ptr_;
  }
  void* host_malloc(wholegraph_tensor_description_t* tensor_desc)
  {
    ptr_ = output_mem_fns_->malloc_fn(
      tensor_desc, WHOLEGRAPH_MA_HOST, memory_context_, output_mem_fns_->global_context);
    return ptr_;
  }
  void* pinned_malloc(size_t elt_count, wholegraph_dtype_t data_type)
  {
    ...
    get_tensor_description(&tensor_description, elt_count, data_type);
    ptr_ = output_mem_fns_->malloc_fn(
      &tensor_description, WHOLEGRAPH_MA_PINNED, memory_context_, output_mem_fns_->global_context);
    return ptr_;
  }
  void* pinned_malloc(wholegraph_tensor_description_t* tensor_desc)
  {
    ptr_ = output_mem_fns_->malloc_fn(
      tensor_desc, WHOLEGRAPH_MA_PINNED, memory_context_, output_mem_fns_->global_context);
    return ptr_;
  }
 ...
 private:
  ...
  wholegraph_output_memory_func_t* output_mem_fns_ = nullptr;
