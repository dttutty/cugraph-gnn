...
typedef struct GraphAppendUniqueTestParam {
  ...
  GraphAppendUniqueTestParam& set_target_dtype(wholegraph_dtype_t new_target_node_dtype)
  {
    target_node_dtype   = new_target_node_dtype;
    neighbor_node_dtype = new_target_node_dtype;
    return *this;
  }
  wholegraph_array_description_t get_target_node_desc() const
  {
    return wholegraph_create_array_desc(target_node_count, 0, target_node_dtype);
  }
  wholegraph_array_description_t get_neighbor_node_desc() const
  {
    return wholegraph_create_array_desc(neighbor_node_count, 0, neighbor_node_dtype);
  }
  ...
  wholegraph_dtype_t target_node_dtype   = WHOLEGRAPH_DT_INT;
  wholegraph_dtype_t neighbor_node_dtype = target_node_dtype;
...
TEST_P(GraphAppendUniqueParameterTests, AppendUniqueTest)
{
  ...
  size_t target_node_size   = wholegraph_get_memory_size_from_array(&target_node_desc);
  size_t neighbor_node_size = wholegraph_get_memory_size_from_array(&neighbor_node_desc);
  ...
  wholegraph_array_description_t neighbor_raw_to_unique_mapping_desc =
    wholegraph_create_array_desc(neighbor_node_count, 0, WHOLEGRAPH_DT_INT);
  ...
  EXPECT_EQ(cudaMemcpyAsync(dev_neighbor_nodes_ptr,
                            ...
                            stream),
            cudaSuccess);
  wholegraph_tensor_t target_node_tensor, neighbor_node_tensor,
    output_neighbor_raw_to_unique_mapping_tensor;
  wholegraph_tensor_description_t target_node_tensor_desc, neighbor_node_tensor_desc,
    output_neighbor_raw_to_unique_mapping_tensor_desc;
  wholegraph_copy_array_desc_to_tensor(&target_node_tensor_desc, &target_node_desc);
  wholegraph_copy_array_desc_to_tensor(&neighbor_node_tensor_desc, &neighbor_node_desc);
  wholegraph_copy_array_desc_to_tensor(&output_neighbor_raw_to_unique_mapping_tensor_desc,
  ...
  EXPECT_EQ(wholegraph_make_tensor_from_pointer(
            ...
            WHOLEGRAPH_SUCCESS);
  EXPECT_EQ(
    wholegraph_make_tensor_from_pointer(&output_neighbor_raw_to_unique_mapping_tensor,
                                         dev_output_neighbor_raw_to_unique_mapping_ptr,
                                         &output_neighbor_raw_to_unique_mapping_tensor_desc),
    WHOLEGRAPH_SUCCESS);
  wholegraph_env_func_t* default_env_func = wholegraph::get_default_env_func();
  wholegraph::default_memory_context_t output_unique_node_memory_ctx;
  ...
  host_output_unique_nodes_ptr =
    malloc(total_unique_count * wholegraph_dtype_get_element_size(target_node_desc.dtype));
  ...
  EXPECT_EQ(
    cudaMemcpyAsync(host_output_unique_nodes_ptr,
                    ...
                    total_unique_count * wholegraph_dtype_get_element_size(target_node_desc.dtype),
  ...
  graph_ops::testing::host_gen_append_unique_neighbor_raw_to_unique(
    host_output_unique_nodes_ptr,
    wholegraph_create_array_desc(total_unique_count, 0, target_node_desc.dtype),
    host_neighbor_nodes_ptr,
    neighbor_node_desc,
    (void**)&ref_host_output_neighbor_raw_to_unique_mapping_ptr,
    neighbor_raw_to_unique_mapping_desc);

  if (target_node_desc.dtype == WHOLEGRAPH_DT_INT) {
  ...
  } else if (target_node_desc.dtype == WHOLEGRAPH_DT_INT64) {
  ...
  wholegraph_ops::testing::host_check_two_array_same(
    ...
    wholegraph_create_array_desc(total_unique_count, 0, target_node_desc.dtype),
    ref_host_output_unique_nodes_ptr,
    wholegraph_create_array_desc(ref_total_unique_node_count, 0, target_node_desc.dtype));
...
INSTANTIATE_TEST_SUITE_P(GraphAppendUniqueOpTests,
                         ...
                         ::testing::Values(GraphAppendUniqueTestParam()
                                           ...
                                           GraphAppendUniqueTestParam()
                                             ...
                                             .set_target_dtype(WHOLEGRAPH_DT_INT),
                                           GraphAppendUniqueTestParam()
                                             .set_target_node_count(57)
                                             .set_neighbor_node_count(1235)
                                             .set_target_dtype(WHOLEGRAPH_DT_INT64)));
