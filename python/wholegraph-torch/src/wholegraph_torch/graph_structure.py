...
class GraphStructure(object):
    ...
    def set_csr_graph(
        self, csr_row_ptr: WholeGraphTensor, csr_col_ind: WholeGraphTensor
    ):
        """
    ...
    def set_node_attribute(self, attr_name: str, attr_tensor: WholeGraphTensor):
        """
    ...
    def set_edge_attribute(self, attr_name: str, attr_tensor: WholeGraphTensor):
        """
    ...
    def unweighted_sample_without_replacement_one_hop(
        ...
        *,
        ...
        return wholegraph_ops.unweighted_sample_without_replacement(
            self.csr_row_ptr.wgb_tensor,
            self.csr_col_ind.wgb_tensor,
            center_nodes_tensor,
            max_sample_count,
            random_seed,
