...
from .utils import str_to_wholegraph_log_level
...
def init(
    ...
    wgb.init(0, str_to_wholegraph_log_level(wg_log_level))
...
def init_torch_env_and_create_wg_comm(
    world_rank: int,
    world_size: int,
    local_rank: int,
    local_size: int,
    ...
    """
    init_torch_env(world_rank, world_size, local_rank, local_size, wg_log_level)
