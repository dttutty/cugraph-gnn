...
c10::ScalarType get_c10_scalar_type(wholegraph_dtype_t wg_dtype);

wholegraph_dtype_t get_wholegraph_dtype(torch::ScalarType ts_dtype);
...
void* torch_common_malloc_func(wholegraph_tensor_description_t* tensor_description,
                               void* memory_context,
...
void get_tensor_desc_from_torch_tensor(wholegraph_tensor_description_t* tensor_desc,
                                       const torch::Tensor& t);

void get_array_desc_from_torch_tensor(wholegraph_array_description_t* array_desc,
                                      const torch::Tensor& t);

void get_matrix_desc_from_torch_tensor(wholegraph_matrix_description_t* matrix_desc,
                                       const torch::Tensor& t);
...
class wrapped_torch_tensor {
 public:
  ...
  wholegraph_tensor_t get_wholegraph_tensor() const;
