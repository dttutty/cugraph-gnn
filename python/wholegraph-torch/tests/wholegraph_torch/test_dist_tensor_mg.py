...
from wholegraph_torch import DistTensor, DistEmbedding
...
from pylibwholegraph.binding.wholegraph_binding import finalize as wg_finalize
...
def run_test_dist_tensor_creation(rank, world_size, device, clx, dtype):
    ...
    wg_init(rank, world_size, rank, world_size)
