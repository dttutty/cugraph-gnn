...
import numpy as np
import cupy
from pylibcugraph import sampling as pylibcugraph_sampling
...
from cugraph_pyg.sampler.sampler_utils import (
    _profile_sampler_stages_enabled,
    _record_profile_stage,
    _sync_cuda_for_profile,
    verify_metadata,
)
from cugraph_pyg.sampler.reader import BufferedSampleReader
...
class BaseDistributedSampler:
    ...
    operations that leverage cuGraph's high-performance graph sampling capabilities
    ...
    _func_table = {
        (
            ...
            "uniform",
            True,
        ): pylibcugraph_sampling.homogeneous_uniform_temporal_neighbor_sample,
        (
            "homogeneous",
            "uniform",
            False,
        ): pylibcugraph_sampling.homogeneous_uniform_neighbor_sample,
        (
            "homogeneous",
            "biased",
            True,
        ): pylibcugraph_sampling.homogeneous_biased_temporal_neighbor_sample,
        (
            "homogeneous",
            "biased",
            False,
        ): pylibcugraph_sampling.homogeneous_biased_neighbor_sample,
        (
            "heterogeneous",
            "uniform",
            True,
        ): pylibcugraph_sampling.heterogeneous_uniform_temporal_neighbor_sample,
        (
            "heterogeneous",
            "uniform",
            False,
        ): pylibcugraph_sampling.heterogeneous_uniform_neighbor_sample,
        (
            "heterogeneous",
            "biased",
            True,
        ): pylibcugraph_sampling.heterogeneous_biased_temporal_neighbor_sample,
        (
            "heterogeneous",
            "biased",
            False,
        ): pylibcugraph_sampling.heterogeneous_biased_neighbor_sample,
    }
...
class DistributedNeighborSampler(BaseDistributedSampler):
    ...
    def sample_batches(
        ...
        with _record_profile_stage(profile_stages, "pylibcugraph_neighbor_sample"):
